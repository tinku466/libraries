...
public extension String {
    ...
    /// NSMutableAttributedString from HTML Text
    var fromHTML: NSMutableAttributedString? {
        ...
        guard let strData = self.data(using: String.Encoding.utf8, allowLossyConversion: false) else {
            return nil
        }
        
        let theAttributedString = try? NSMutableAttributedString.init(data: strData, options: option, documentAttributes: nil)
...
public extension NSMutableAttributedString {
    ...
    func setAtt(_ attrMaker: (_ maker: AttributeMaker)->()) -> NSMutableAttributedString {
